...
angular.module('myClientApp') // make sure this is set to whatever it is in your client/scripts/app.js
	.controller('SignupCtrl', function ($scope, $http) { // note the added $http depedency
		...
		signup.submit = function () {
			...
			request.success(function (data) {
				 console.log(data.msg)// to be filled in on success
			});
 
			request.error(function (data) {
				 console.log(data.msg)// to be filled in on error
			});
